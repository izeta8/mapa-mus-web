      ...
      <nav className="container mx-auto px-4 py-3 min-[500px]:py-4 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 min-[500px]:gap-4">
          <a
            ...
            className="inline-flex items-center justify-center px-3 py-1.5 min-[500px]:px-4 min-[500px]:py-2 text-xs min-[500px]:text-sm font-semibold text-white bg-[#33AD6A] hover:bg-[#288A56] rounded-full shadow-sm hover:shadow transition-all duration-200"
          >
            <span className="hidden min-[500px]:inline">Descargar App</span>
            <span className="inline min-[500px]:hidden">Descargar</span>
          </a>
          <Link
            href="/admin/panel"
